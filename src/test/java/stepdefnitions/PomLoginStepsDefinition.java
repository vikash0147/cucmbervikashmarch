 ...
 * io.cucumber.java.en.When; import pageObjects.LoginPage;
 * 
 ...
 * title_of_login_page_is_Free_CRM() {
 * System.out.println("title of login page is Free CRM"); }
 * 
 * @Then("user enters {string} and {string}") public void user_enters_and(String
 * arg1, String arg2) { lp = new LoginPage(driver); lp.enterUserName(arg1);
 ...
 * ) public void user_enters_contact_details_and_and(String arg1, String arg2,
 * String arg3) {
 * 
 ...
 * 
 * driver.close(); System.out.println("Close the browser ");
 * 
 * }
 * 
 * 
